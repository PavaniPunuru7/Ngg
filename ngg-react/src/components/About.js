        ...
        <section id="about" className="section">
            <div>
                <div style={{ paddingTop: '70px', textAlign: 'left', paddingLeft: '100px' }}>
                    <h1 style={{ color: 'rgb(8, 77, 8)', marginBottom: '15px', fontSize: '45px', fontWeight: 'bold' }}>About Us</h1>
                </div>
                <div>
                    <h3 style={{ color: '#444444', fontSize: '26px', paddingLeft: '110px' }}>Why Choose Us</h3>
                    <p style={{ paddingLeft: '115px' }}>
                        At <b>NGG Nursery</b>, we pride ourselves on offering more than just plants.
                        We offer a complete gardening experience that helps you create the green space of your dreams.
